...
import { useStreamContext, getFeatureById } from "@/providers/Stream";
...
export function Thread() {
  ...
  const currentFeature = getFeatureById(assistantId || "");
  ...
  // Update document title based on current feature
  useEffect(() => {
    if (currentFeature) {
      document.title = currentFeature.title;
    } else {
  ...
  return (
    <div className="flex w-full h-screen overflow-hidden">
      ...
      >
        {/* Header - always show with feature name */}
        <div className="flex items-center justify-between gap-3 p-2 z-10 relative border-b">
